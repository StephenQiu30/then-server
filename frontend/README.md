...
前后端工程总规范见 [PROJECT.md](../PROJECT.md)。2026-09-22 已按 [17-27](../docs/plan/17-27-Web设计体系与工程规范同步执行计划.md) 初始化 radix-nova / Lucide / RSC 和统一语义 token。账户页面按 [17-13](../docs/plan/17-13-Web账户管理执行计划.md) 实现；无图衣橱核验页按 [17-31](../docs/plan/17-31-Web衣橱数据核验执行计划.md) 实现。首页、404 与错误重试共用基础页面结构。
...
当前目录交付账户和无图衣橱页面的本地开发验证；公开注册仍需账号、TLS、隐私与运维发布门禁。衣橱页不提供离线 Look 或推荐。
