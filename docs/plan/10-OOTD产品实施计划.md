...
| 3 | [14-01 图片与按需三维](14-01-完整穿搭图与按需三维生成执行计划.md) | approved_with_gates / pending；GATE-01 官方资料只读核验已记录，领域合同已开始并覆盖按用途输入、幂等分类和外部受理/状态对账；真实账号/素材/预算/许可仍缺，图片质量、真实任务/费用/删除、App Client、主动分享待后续 |
