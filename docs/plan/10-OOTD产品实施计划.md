...
当前前端同步见 [17-27](17-27-Web设计体系与工程规范同步执行计划.md)，范围为设计体系和必要工程文件，账户业务仍按 17-13 进入实施。
...
| --- | --- | --- | --- |
| [17-27 Web 规范同步](17-27-Web设计体系与工程规范同步执行计划.md) | approved / completed（本地基础工程） | shadcn/Radix、token、必要路由状态与全部前端本地门禁通过 | 新改动尚未提交，新增前端 CI 待远端验证；账户业务按 17-13 |
