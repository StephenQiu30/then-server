...
| 计划和记录 | 今日/未来计划、实际穿着、反馈、私人穿搭日记与日历、编辑和删除 | 分阶段接入 |
| 图文社区 | 独立发布快照、公开主页、发现/关注、赞藏评关、举报屏蔽与审核 | 设计已确认；19-02 已实现账号状态与 handle/bio 公开资料，其余分片待实现 |
| 账号和同步 | 注册/登录、本人资料、会话、跨设备同步、冲突处理和账户删除 | 云阶段 |
| 结果管理 | 收藏、下载、系统分享、删除和来源/版本说明 | 随结果类型逐步开放 |
| 隐私和控制 | 分目的同意、私有资产、血缘、可撤回、可验证删除、日志脱敏 | 每阶段前置 |

用户于 2026-09-16 确认新增私人穿搭日记（允许轻量生活记录）和首版图文社区：公开主页、发现/关注流、点赞收藏评论、关注、举报屏蔽与审核。它们进入完整产品需求，后端先设计再编码；详见 [Design 21](21-后端产品边界与领域设计.md)、[表设计](22-后端数据库设计.md)、[接口设计](23-后端接口设计.md) 和 [PRD 19](../prd/19-每日记录与穿搭社区需求.md)。App 开发当前暂停，既有三入口是已实现阶段导航，不视作新增社区的信息架构定稿。短视频社区、私信、创作者交易、商城、广告与订阅继续分期。
...
6. 私人日记与图文社区及基础互动已纳入首版需求，先完成后端合同审查；短视频社区、私信、商城和造型师交易继续后续分期。
