...
- 视觉稿证据：2026-09-15 以当前 App 首页和内置衣橱截图为结构参考，重新生成三张 `853×1844` 移动端候选；三稿均使用可落地的风格化三维人物、真实底部导航和正/侧/背观察入口，替换容易被误认为照片生成结果的早期摄影式草图。当前只用于选稿，不是生产 UI 或三维资产验收。
...
三张候选均按当前文档中的显示顺序编号，文件尺寸相同；SHA-256 用于选定后把唯一视觉基线写入 11-02 执行计划：

| 显示顺序 | 文件 | SHA-256 |
| --- | --- | --- |
| 1 | `woo-minimal.png` | `562b3db09c569ab1c2c8a1ea7310356ca9c569ac66c58a9ec111e3462224ebf9` |
| 2 | `soft-studio.png` | `2087b623cbe878b5230b6f7fb1a4f67351e6040d4552acc60e48719ac47a254d` |
| 3 | `editorial-timeline.png` | `255c94b2ff8127bfe0edc0211c699101e8b4778cf06beaf73e21e95d37805d57` |
