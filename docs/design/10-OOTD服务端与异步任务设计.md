...
当前已实现健康、数据库就绪、注册/会话、本人账户 CRUD 和 [17-18](../plan/17-18-本人成年声明API执行计划.md) 本人成年声明。当前业务依赖 PostgreSQL，Redis 只用于认证限流。目录/SOP 见 [Design 02](02-后端架构.md)，精确技术栈见 [Design 01](01-技术选型.md)。GORM record + 集中 AutoMigrate 管理开发 schema。
