...
func (r *PrivacyRepository) GetSelfAdultDeclaration(ctx context.Context, userID, version string) (model.SelfAdultDeclaration, error) {
	...
	if err != nil {
		return model.SelfAdultDeclaration{}, model.ErrPrivacyUnavailable
	}
	return selfAdultDeclarationFromRecord(record), nil
}

func (r *PrivacyRepository) ConfirmSelfAdultDeclaration(ctx context.Context, userID, version string, at time.Time) (model.SelfAdultDeclaration, error) {
	var result model.SelfAdultDeclaration
...
func (r *PrivacyRepository) WithdrawSelfAdultDeclaration(ctx context.Context, userID, version string, at time.Time) (model.SelfAdultDeclaration, error) {
	var result model.SelfAdultDeclaration
	err := r.database.WithContext(ctx).Transaction(func(tx *gorm.DB) error {
		record, found, err := lockSelfAdultDeclaration(ctx, tx, userID, version)
		if err != nil {
...
func emptySelfAdultDeclaration(version string) model.SelfAdultDeclaration {
	return model.SelfAdultDeclaration{PolicyVersion: version}
}

func selfAdultDeclarationFromRecord(record selfAdultDeclarationRecord) model.SelfAdultDeclaration {
	confirmedAt := record.ConfirmedAt
	return model.SelfAdultDeclaration{
